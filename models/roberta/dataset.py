...
class DLPDataset(Dataset):
    """Tokenizes texts with roberta-base and pairs them with multi-label targets."""
...
def collate_fn(batch):
    ...
    # RoBERTa uses 1 as the padding token id
    input_ids_padded = torch.ones(B, max_len, dtype=torch.long)
